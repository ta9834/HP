...
const NEWS = [
  ...
  {
    id: "004", date: "2026.08.05", cat: "お知らせ",
    title: "夏季休業のお知らせ",
    tone: ["#f0b87a", "#e89aae"],
    lead: "平素より格別のお引き立てを賜り、誠にありがとうございます。誠に勝手ながら、夏季休業期間につきまして、下記のとおりご案内申し上げます。",
    sections: [
      { h: "休業期間", type: "info", items: [
        ["休業日", "2026年8月9日（日）〜 8月16日（日）"],
        ["通常営業再開", "2026年8月17日（月）より"],
      ]},
      { h: "お問い合わせについて", type: "para", body: "休業期間中にいただいたお問い合わせにつきましては、2026年8月17日（月）以降、順次対応させていただきます。お客様には大変ご不便をおかけいたしますが、何卒ご理解賜りますようお願い申し上げます。" },
  ...
  {
    id: "003", date: "2026.04.30", cat: "お知らせ",
    title: "クールビズ実施のお知らせ",
    tone: ["#7dc9b7", "#cdd67a"],
  ...
  {
    id: "002", date: "2026.04.29", cat: "お知らせ",
  ...
  {
    id: "001", date: "2026.04.28", cat: "お知らせ",
